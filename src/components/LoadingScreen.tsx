...
export function LoadingScreen() {
  ...
  return (
    <div className="fixed inset-0 bg-white flex flex-col items-center justify-center z-50 font-pixel">
      {/* Decorative Stickers */}
      ...
      <div className="w-80 h-8 bg-white pixel-borders border-4 border-black overflow-hidden">
        <div 
